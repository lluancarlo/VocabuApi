    ...
    public partial class InitialProject : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordTypesOfSpeech", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WordTypesOfSpeech_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordTypesOfSpeech_Id",
                table: "WordTypesOfSpeech",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WordTypesOfSpeech_WordId",
                table: "WordTypesOfSpeech",
                column: "WordId");
        }
